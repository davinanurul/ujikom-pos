...
<head>
    ...
    <!-- Pignose Calender -->
    <link href="{{ asset('asset') }}/dist/plugins/pg-calendar/css/pignose.calendar.min.css" rel="stylesheet">
    <!-- Chartist -->
    <link rel="stylesheet" href="{{ asset('asset') }}/dist/plugins/chartist/css/chartist.min.css">
    <link rel="stylesheet"
        href="{{ asset('asset') }}/dist/plugins/chartist-plugin-tooltips/css/chartist-plugin-tooltip.css">
    <!-- Custom Stylesheet -->
...
<body>
    ...
    ***********************************-->
    ...
    <!-- Chartjs -->
    <script src="{{ asset('asset') }}/dist/plugins/chart.js/Chart.bundle.min.js"></script>
    <!-- Circle progress -->
    <script src="{{ asset('asset') }}/dist/dist/plugins/circle-progress/circle-progress.min.js"></script>
    <!-- Datamap -->
    <script src="{{ asset('asset') }}/dist/plugins/d3v3/index.js"></script>
    <script src="{{ asset('asset') }}/dist/plugins/topojson/topojson.min.js"></script>
    <script src="{{ asset('asset') }}/dist/plugins/datamaps/datamaps.world.min.js"></script>
    <!-- Morrisjs -->
    <script src="{{ asset('asset') }}/dist/plugins/raphael/raphael.min.js"></script>
    <script src="{{ asset('asset') }}/dist/plugins/morris/morris.min.js"></script>
    <!-- Pignose Calender -->
    <script src="{{ asset('asset') }}/dist/plugins/moment/moment.min.js"></script>
    <script src="{{ asset('asset') }}/dist/plugins/pg-calendar/js/pignose.calendar.min.js"></script>
    <!-- ChartistJS -->
    <script src="{{ asset('asset') }}/dist/plugins/chartist/js/chartist.min.js"></script>
    <script src="{{ asset('asset') }}/dist/plugins/chartist-plugin-tooltips/js/chartist-plugin-tooltip.min.js"></script>



    <script src="{{ asset('asset') }}/dist/js/dashboard/dashboard-1.js"></script>
    <script>
        (function($) {
            "use strict"
